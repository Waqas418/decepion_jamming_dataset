...
for sample = 1:2
    ...
    % Randomly select the slice period between 5 and 10 microseconds
    slice_period = (10e-6 - 5e-6) * rand + 5e-6; % in microseconds

    % Randomly select the jamming duty cycle between 20% and 50%
    ...
    % Save the figure
    saveas(gcf, fullfile(folderPath, sprintf('SNJ_RealPart_Sample_%d.png', sample)));
    ...
    % set(gca, 'YDir', 'reverse');
    % % Save the figure
    % saveas(gcf, fullfile(folderPath, sprintf('SNJ_ImaginaryPart_Sample_%d.png', sample)));
    % 
    ...
    % set(gca, 'YDir', 'reverse');
    % % Save the figure
    % saveas(gcf, fullfile(folderPath, sprintf('SNJ_Modulus_Sample_%d.png', sample)));
    % 
    ...
    % set(gca, 'YDir', 'reverse');
    % % Save the figure
    % saveas(gcf, fullfile(folderPath, sprintf('SNJ_Phase_Sample_%d.png', sample)));
end
